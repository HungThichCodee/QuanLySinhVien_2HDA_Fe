...
import * as service from '../services/subjects.service.js'
...
function SubjectsPage() {
  ...
  async function handleSubmit(e) { e.preventDefault(); try { if (editItem) { await updateItem(editItem._id, form); setToast({ message: 'Cap nhat thanh cong', type: 'success' }) } else { await createItem(form); setToast({ message: 'Tao moi thanh cong', type: 'success' }) }; setModalOpen(false) } catch (err) { setToast({ message: err.message, type: 'error' }) } }
